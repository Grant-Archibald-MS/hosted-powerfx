...
sys.path.append(os.path.join(os.path.dirname(__file__), '../dotnet/bin/Release/netstandard2.0/win-x64/publish'))
...
def init():
    power_fx_type = Type.GetType("PowerFx.HostedPowerFx, PowerFx")
